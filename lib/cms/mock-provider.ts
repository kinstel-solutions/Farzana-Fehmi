...
const heroData: HeroData = {
  ...
  desktopImages: [
    '/photos/hero-v3/hero-v3-1.webp',
    '/photos/hero-v3/hero-v3-2.webp',
    '/photos/hero-v3/hero-v3-3.webp',
    '/photos/hero-v3/hero-v3-4.webp',
    '/photos/hero-v3/hero-v3-5.webp',
    '/photos/hero-v3/hero-v3-6.webp',
    '/photos/hero-v3/hero-v3-7.webp',
    '/photos/hero-v3/hero-v3-8.webp',
  ],
