           ...
           >
              <div>
                ...
                <p className="text-gray-600 font-light">
                  <a href="mailto:farzana@fehmifarz.com" className="hover:text-black transition-colors">farzana@fehmifarz.com</a> <br />
                  <a href="tel:+919876543210" className="hover:text-black transition-colors">+91 987 654 3210</a>
                </p>
              </div>

              <div>
                <h3 className="uppercase tracking-widest text-xs font-semibold mb-2 text-gray-900">Follow Us</h3>
                <div className="flex gap-4">
                  <a href="https://instagram.com/fehmifarzanadesigns" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-black transition-colors">
