      ...
      <div className="container mx-auto px-4 md:px-8 max-w-4xl">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-500 font-light">All measurements are in inches.</p>
          </div>
          
          <div className="space-y-12">
            {/* Kurta Table */}
            <div className="space-y-4">
              <h2 className="text-xl font-medium text-gray-900 font-sans border-b border-gray-200 pb-2">Kurta</h2>
            ...
            {/* Bottom/Pant Table */}
            <div className="space-y-4">
              <h2 className="text-xl font-medium text-gray-900 font-sans border-b border-gray-200 pb-2">Bottom/Pant</h2>
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-left whitespace-nowrap">
                  <thead className="text-xs text-gray-500 uppercase bg-gray-50">
                    <tr>
            ...
            <div className="bg-gray-50 p-6 text-center space-y-2 text-sm text-gray-600 font-light rounded-sm">
              ...
              <p className="text-xs text-gray-400 pt-2 italic">Fit may vary by style and personal preference.</p>
            </div>
          </div>
        </motion.div>
      </div>
