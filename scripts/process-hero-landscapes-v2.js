...
const sourceDir = path.resolve('assets/originals/hero-and-cards/Hero-images-here/landscapes-v2');
const destDir = path.resolve('public/photos/hero-landscapes-v2');
...
const processImages = async () => {
    try {
        ...
        for (let i = 0; i < files.length; i++) {
            ...
            const outputFilename = `hero-landscape-v2-${i + 1}.webp`;
