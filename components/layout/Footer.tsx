  ...
  return (
    <footer className="bg-black text-white pt-16 pb-4">
      <div className="mx-auto px-8 md:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-24 mb-4">
          {/* Brand */}
          ...
          {/* Links */}
          <div>
            <h3 className="uppercase tracking-widest text-xs font-semibold mb-6 text-gray-400">
              Explore
            </h3>
        ...
        <div className="border-t border-gray-900 pt-4 flex flex-col items-center gap-4 text-center">
          <div className="max-w-3xl space-y-4">
            <h3 className="uppercase tracking-[0.2em] text-[12px] font-semibold text-gray-100">
            ...
            <div className="space-y-1">
              <p className="text-gray-200 text-[12px] leading-relaxed font-light max-w-2xl mx-auto italic">
                ...
                Australia and pay our respect to Elders past, present and
                emerging.
              </p>
              <p className="text-gray-200 text-[12px] leading-relaxed font-light max-w-2xl mx-auto">
                We recognize our responsibility to tread lightly on our planet
                and are committed to minimize the impact of our business has on
                our environment and do our best to implement environmentally
                sustainable procedures wherever possible.
              </p>
            </div>
          </div>
